...
export function getDisplayStatus(args: {
  status: string;
  hasBank: boolean;
  ...
  switch (status) {
    ...
    case "BALANCE_VERIFIED":
      return {
        ...
        displaySubtitle: "Balance verified",
    ...
    case "QUOTED":
      return {
        ...
        displaySubtitle: "Reviewing quote",
    ...
    case "USER_CONFIRMED":
      return {
        ...
        displaySubtitle: "Queued for processing",
    ...
    case "VALUE_CAPTURE_PENDING":
      return {
        displayStatus: "Processing",
        displaySubtitle: "Capturing value",
    ...
    case "VALUE_CAPTURED":
      return {
        displayStatus: "Processing",
        displaySubtitle: "Value captured",
        processingPercent: 45,
        requiresBank: false,
        isTerminal: false,
      };
    ...
    case "OFFRAMP_PENDING":
      return {
        displayStatus: "Processing",
        displaySubtitle: "Preparing cashout",
    ...
    case "PAYOUT_PENDING":
      if (!hasBank) {
        return {
          ...
          displaySubtitle: "Link a bank to cash out",
      ...
      return {
        displayStatus: "Processing",
        displaySubtitle: "Sending payout",
    ...
    case "COMPLETED":
      return {
        ...
        displaySubtitle: "Cashout complete",
    ...
    case "CANCELED":
      return {
        ...
        displaySubtitle: "Conversion canceled",
        processingPercent: 100,
        requiresBank: false,
        isTerminal: true,
      };
    ...
    default:
      return {
        displayStatus: "Processing",
        displaySubtitle: "In progress",
        processingPercent: terminal(status) ? 100 : 50,
        requiresBank: false,
        isTerminal: terminal(status),
      };
  }
}
